				...
				<div class="container">
					...
					<div class="banner-grids">
						<div class="col-md-6 banner-grid">
							<h4>We Bought a Zoo</h4>
							<p>All you need is 20 seconds of insane courage.20 seconds of embarrassing bravery and i guarantee you ,something good will come out of it</p>
						</div>
						<div class="col-md-6 banner-grid">
						<h4>What is a zoo</h4>
							<p>People forget that throughout the human cruelty animals have been tortured for decades and zoo have preserved these species for decades.</p>
						</div>
